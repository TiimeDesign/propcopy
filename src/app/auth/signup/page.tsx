      ...
      <div style={{ width: '100%', maxWidth: '460px', position: 'relative', zIndex: 1 }}>
        ...
        <div className="glass-card" style={{ padding: 'clamp(28px, 5vw, 44px)' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '20px' }}>
            ...
            <span style={{ color: 'rgba(255,255,255,0.3)', fontSize: '12px' }}>or sign up with email</span>
            <div style={{ flex: 1, height: '1px', background: 'rgba(255,255,255,0.1)' }} />
          </div>
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
            <div>
              <label style={{ display: 'block', color: 'rgba(255,255,255,0.6)', fontSize: '13px', fontWeight: 600, marginBottom: '6px' }}>Full Name</label>
              <input
                type="text"
                required
            ...
            <div>
              <label style={{ display: 'block', color: 'rgba(255,255,255,0.6)', fontSize: '13px', fontWeight: 600, marginBottom: '6px' }}>Password</label>
              <input
                type="password"
                required
            ...
            <div>
              <label style={{ display: 'block', color: 'rgba(255,255,255,0.6)', fontSize: '13px', fontWeight: 600, marginBottom: '6px' }}>Confirm Password</label>
              <input
                type="password"
                required
            ...
            <button
              ...
              disabled={loading}
              className="btn-gold"
              style={{ padding: '15px', fontSize: '15px', marginTop: '4px' }}
            >
              {loading ? (
          ...
          <p style={{ textAlign: 'center', marginTop: '20px', color: 'rgba(255,255,255,0.35)', fontSize: '12px', lineHeight: 1.6 }}>
